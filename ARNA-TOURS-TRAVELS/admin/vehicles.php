...
function vehicleUpload(?array $file, ?string $oldImage = null): string
{
    ...
    if (($file['size'] ?? 0) > 4 * 1024 * 1024) {
        throw new RuntimeException('Vehicle image must be 4 MB or smaller.');
    }
...
<div class="admin-card mb-4">
    ...
    <form method="post" enctype="multipart/form-data" class="row g-3 p-4">
        ...
        <div class="col-md-6"><label class="form-label">Vehicle Image</label><input class="form-control" type="file" name="image" accept="image/jpeg,image/png,image/webp"><div class="form-text">JPG, PNG or WEBP · max 4 MB</div></div>
